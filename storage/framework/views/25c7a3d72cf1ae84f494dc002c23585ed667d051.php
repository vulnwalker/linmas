                    ...
                    <div class="card-header">
                      <?php
                        if (Auth::user()->adminis == 1 || Auth::user()->adminis == 3) {
                            ...
                            $idAdminis  = "";
                            $hrefUser   = "href=/publikasi/publikasi/create";
                            $class      = "";
                        }
                      ?>
                      <div class="nav-tabs-navigation">
                        <div class="nav-tabs-wrapper">
                          <ul id="tabs" class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                              <a class="nav-link" href="<?php echo e(url("publikasi/publikasi")); ?>" aria-expanded="false" style="color: blue; font-weight: bold; padding-right: .2rem;">Kategori Publikasi |</a>
                            </li>
                            <li class="nav-item">
                      ...
                      <div class="row">
                          <div class="col-md-6">
                            <h4 class="card-title">Kategori Publikasi</h4>
                        ...
                        <div >
                          <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                              ...
                              <tbody id="tbody">
                                <?php $__currentLoopData = $slcPublikasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    $(document).ready(function(){
      ...
      $('#edit').on('click', function(){
        ...
        if(hakAkses == 1 || hakAkses == 3){
          ...
          window.location.href = "http://linmas.pilar.web.id/publikasi/publikasi/"+id+"/edit";
        }
      });
      // end edit
    });
