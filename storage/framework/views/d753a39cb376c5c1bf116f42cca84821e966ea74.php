...
<?php $__env->startSection('title'); ?>
  Edit Pembinaan #<?php echo e($pembinaan->nama); ?>
            ...
            <div class="col-md-12">
                <div class="card">
                 <div class="card-header">
                  <div class="row">
                      <div class="col-md-12">
                        <h4 class="card-title">Edit Pembinaan #<?php echo e($pembinaan->nama); ?></h4>
                        <hr>
                      </div>
                  </div>
                  </div>
                    <div class="card-body">
                        ...
                        <?php echo $__env->make('pembinaan.pembinaan.form', ['formMode' => 'edit'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
