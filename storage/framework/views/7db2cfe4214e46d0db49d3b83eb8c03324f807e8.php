            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php echo $__env->make('images.images.form', ['formMode' => 'edit'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <button type="button" class="btn btn-primary" id="editImages" name="editImages" onclick="edit()">SIMPAN</button>
                        <a href="<?php echo e(url('images/images')); ?>">
