                ...
                <div class="card">
                    <div class="card-header">
                      <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <a href="<?php echo e(url('tugas/tugas/create')); ?>">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-2">
                          <input type="text" name="jns_tugas" id="jns_tugas" class="form-control">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-1">
                                ...
                                <tbody id="tbody">
                                  <?php $__currentLoopData = $jenislinmas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr id="<?php echo e($value->id); ?>">
                                      ...
                                      <td><?php echo e($value->nm_tugas); ?></td>
                                      <?php if($value->sifat == 1): ?>
                                        <td>Rutin</td>
                                      <?php else: ?>
                                        <td>Berkala</td>
                                      <?php endif; ?>
