...
<div class="row">
    <div class="col-md-12">
        <div class="row">
            ...
            <div style="padding-right: 15px;">
              <div class="form-group" style="width: 35px;">
                <?php echo Form::text('kd_kec', null, ['id' => 'kd_kec', 'class' => 'form-control kode', 'onkeyup'=>'kode()']); ?>

              </div>
            </div>
            <div>
              <div class="form-group" style="width: 35px;">
                <?php echo Form::text('kd_kel_des', null, ['id' => 'kd_kel_des', 'class' => 'form-control kode', 'onkeyup'=>'kode()']); ?>
