                    ...
                    <div class="card-header">
                      <?php
                        if (Auth::user()->adminis == 1 || Auth::user()->adminis == 3) {
                            ...
                            $idAdminis  = "";
                            $hrefUser   = "href=/jenisSapras/jenisSapras/create";
                            $class      = "";
                        }
                      ?>
                      <div class="nav-tabs-navigation">
                        <div class="nav-tabs-wrapper">
                          <ul id="tabs" class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                              <a class="nav-link" href="<?php echo e(url("wilayah/wilayah")); ?>" aria-expanded="true" style="color: red; font-weight: bold; padding-right: .2rem;">Wilayah |</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link" href="<?php echo e(url("jenisSapras/jenisSapras")); ?>" aria-expanded="false" style="color: blue; font-weight: bold; padding-right: .2rem;">Jenis Sapras |</a>
                            </li>
                            <li class="nav-item">
                      ...
                      <div class="row">
                          <div class="col-md-6">
                            <h4 class="card-title">Jenis Sapras</h4>
                        ...
                        <div >
                          <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                              ...
                              <tbody id="tbody">
                                <?php $__currentLoopData = $slcJnsSapras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id="<?php echo e($value->id); ?>">
                                  ...
                                  <?php else: ?>
                                    <td style="text-align: center;">Belum Terpakai</td>
                                  <?php endif; ?>
                                </tr>
    ...
    $(document).ready(function(){
      ...
      $('#edit').on('click', function(){
        ...
        if(hakAkses == 1 || hakAkses == 3){
          ...
          window.location.href = "http://linmas.pilar.web.id/jenisSapras/jenisSapras/"+id+"/edit";
        }
      });
      // end edit
    });
