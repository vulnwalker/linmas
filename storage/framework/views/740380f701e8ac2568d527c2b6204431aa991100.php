...
<div class="row">
  <div class="col-md-12">
    <div class="card-body">
      <div class="row">
        <?php echo Form::label('no_doc', 'No Doc :', ['class' => 'col-md-3 col-form-label']); ?>
...
<div class="row">
  <div class="col-md-6">
    ...
    <div class="col-md-6">
          ...
          <div class="row">
              <div class="col-md-12">
                <h4 class="card-title">Data Linmas</h4>
              </div>
          </div>
          </div>
            <div class="card-body">
              <div class="form-group<?php echo e($errors->has('status_linmas') ? 'has-error' : ''); ?>">
                <div class="row">
                  <?php echo Form::label('status_linmas', 'Status Linmas :', ['class' => 'col-md-3 col-form-label']); ?>

                  <div class="col-md-2">
                    <div class="form-group">
                  <?php echo Form::select('status_linmas', ['' => '', '1' => 'Ya', '2' => 'Tidak'], $statusLimas, ['class' => 'form-control']); ?>

                    </div>
                  </div>
                  
                  <?php echo $errors->first('status_limas', '<p class="help-block">:message</p>'); ?>

                </div>
              </div>

              <div class="form-group<?php echo e($errors->has('jenis_linmas') ? 'has-error' : ''); ?>">
                <div class="row">
                  <?php echo Form::label('jenis_linmas', 'Jenis Limas :', ['class' => 'col-md-3 col-form-label']); ?>

                  <div class="col-md-3">
                    <div class="form-group">
                      <?php echo Form::select('jenis_linmas', $JenisLinmas, null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']); ?>
