                      ...
                      <div class="nav-tabs-navigation">
                        <div class="nav-tabs-wrapper">
                          <ul id="tabs" class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                              <a class="nav-link" href="<?php echo e(url("images/images")); ?>" aria-expanded="false" style="color: blue; font-weight: bold;">Images</a>
                            </li>
                          </ul>
                        </div>
                      </div>
                        ...
                        <div >
                          <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                              ...
                              <tbody id="tbody">
                                <?php $__currentLoopData = $slcImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id="<?php echo e($value->id); ?>">
                                  ...
                                  <td>
                                    <img src="<?php echo e(url('assets/images/upload/',$value->resized_name,'')); ?>">
                                  </td>
                                  ...
                                  <td><?php echo e(date("d-m-Y H:i:s", strtotime($value->updated_at))); ?></td>
                                </tr>
