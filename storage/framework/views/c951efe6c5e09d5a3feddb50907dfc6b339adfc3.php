...
<div class="form-group<?php echo e($errors->has('id_publikasi') ? 'has-error' : ''); ?>">
 <div class="row">
   <?php echo Form::label('id_publikasi', 'KATEGORI PUBLIKASI', ['class' => 'col-md-3 col-form-label']); ?>

   <div class="col-md-2">
     <div class="form-group">
     <?php echo Form::select('id_publikasi', $slcPublikasi, null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']); ?>

     </div>
   </div>
   <?php echo $errors->first('id_publikasi', '<p class="help-block">:message</p>'); ?>
