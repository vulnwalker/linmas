...
<script async defer src="<?php echo e(asset('js/buttons.js')); ?>"></script>
<!-- Chart JS -->
...
<script src="<?php echo e(asset('assets/js/paper-dashboard.min790f.js?v=2.0.1')); ?>" type="text/javascript"></script>
