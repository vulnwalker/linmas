                  ...
                  <div class="card-header">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3" style="text-align:right;">
                          ...
                          <input type="hidden" name="hakAkses" id="hakAkses" value="<?php echo e(Auth::user()->pelaporan); ?>">
                    ...
                    <div class="card-body"  style="padding: 15px 15px 10px !important;">
                        <div>
                             <table  class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody id="tbody">
                                <?php $__currentLoopData = $Pelaporan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <?php
