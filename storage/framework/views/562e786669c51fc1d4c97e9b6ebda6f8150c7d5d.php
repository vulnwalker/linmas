                      ...
                      <div class="nav-tabs-navigation">
                        <div class="nav-tabs-wrapper">
                          <ul id="tabs" class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                              <a class="nav-link" href="<?php echo e(url("katLaporan/katLaporan")); ?>" aria-expanded="false" style="color: blue; font-weight: bold; padding-right: .2rem;">Kategori Laporan |</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div >
                          <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                              ...
                              <tbody id="tbody">
                                <?php $__currentLoopData = $slcKatLaporan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
