                    ...
                    <!--  <?php echo Form::close(); ?> -->
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                          ...
                          <div class="row" style="width: 104%;">
                            <div class="col-md-3">
                              <input type="text" id = "nama_pos2"  name="nama_pos2" class="form-control" placeholder="Cari Nama Pos Jaga.." value="<?php echo e(request('nama_pos')); ?>" style="font-size: 15px; border: 1px solid #b5daff;width: 100%;margin-bottom: 2%;">
                            </div>
                            <div class="col-md-3">
                              <?php echo Form::select('kontruksi', [
                                 '0' => ' -- Kontruksi -- ',
                                 '1' => 'Permanen',
                                 '2' => 'Semi Permanen',
                                 '3' => 'Darurat',
                            ...
                            <div class="col-md-3">
                              <?php echo Form::select('aktifitas', [
                                 '0' => ' -- Aktifitas -- ',
                                 '1' => 'Aktif',
                                 '2' => 'Tidak Aktif',
                          ...
                          <div class="row" style="width: 104%;">
                            <div class="col-md-6">
                              <div class="">
                                <div class="row">
                                  <div class="col-md-12">
                                    <input type="text" id = "nama_pos"  name="nama_pos" class="form-control" placeholder="Cari Nama Pos Jaga.." value="<?php echo e(request('nama_pos')); ?>" style="font-size: 15px; border: 1px solid #b5daff;width: 100%;margin-bottom: 2%;">
                                  </div>
                                </div>
                            ...
                            <div class="col-md-6">
                              <div class="">
                                ...
                                <div class="row">
                                  <div class="col-md-6">
                                    <input type="text" id = "luas"  name="luas" class="form-control" placeholder="Luas Bangunan" value="<?php echo e(request('luas')); ?>" style="font-size: 15px;border: 1px solid #b5daff; width: 100%; margin-bottom: 3%;">
                                  </div>
                                  <div class="col-md-6">
                                    <input type="text" id = "luas_tanah"  name="luas_tanah" class="form-control" placeholder="Luas Tanah" value="<?php echo e(request('luas_tanah')); ?>" style="font-size: 15px;border: 1px solid #b5daff; width: 100%; margin-bottom: 3%;">
                                  </div>
                                </div>
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                              <div class="">
                                <div class="row">
                                  <div class="col-md-12">
                                    <input type="text" id = "kepemilikan"  name="kepemilikan" class="form-control" placeholder="Nama Kepemilikan" value="<?php echo e(request('kepemilikan')); ?>" style="font-size: 15px;border: 1px solid #b5daff;width: 100%;margin-bottom: 2%;">
                                  </div>
                                </div>
