                    ...
                    <div class="card-header">
                      <?php
                        if (Auth::user()->adminis == 1 || Auth::user()->adminis == 3) {
                            ...
                            $idAdminis  = "";
                            $hrefUser   = "href=/jabatan/jabatan/create";
                            $class      = "";
                        }
                      ?>
                        ...
                        <div >
                          <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                              ...
                              <tbody id="tbody">
                                <?php $__currentLoopData = $slcJabatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    $(document).ready(function(){
      ...
      $('#edit').on('click', function(){
        ...
        if(hakAkses == 1 || hakAkses == 3){
          ...
          window.location.href = "http://linmas.pilar.web.id/jabatan/jabatan/"+id+"/edit";
        }
      });
      // end edit
    });
