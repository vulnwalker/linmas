...
<tbody id="tbody">
  <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
      <td style="text-align: center;"><?php echo e(isset($loop->iteration) ? $loop->iteration : $key['id']); ?></td>
      <td><?php echo e($key->nama); ?></td>
      <td><?php echo e($key->ket_item); ?></td>
      <td>Kec. 
        <?php if(!empty($key->id_kecamatan)): ?>
        <?php  
      ...
      <td>Kel/Des. 
        <?php if(!empty($key->id_kecamatan) && !empty($key->id_kelurahan)): ?>
        <?php  
      ...
      <td style="text-align: center;"><?php echo e($key->tahun); ?></td>
      <td style="text-align: center;"><?php echo e($key->kondisi); ?></td>
    </tr>
