                      ...
                      <div class="nav-tabs-navigation">
                        <div class="nav-tabs-wrapper">
                          <ul id="tabs" class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                              <a class="nav-link" href="{{ url("wilayah/wilayah") }}" aria-expanded="true" style="color: blue; font-weight: bold; padding-right: .2rem;">Wilayah |</a>
                            </li>
                            <li class="nav-item">
                              ...
                              <tbody id="tbody">
                                ...
                                <tr id="{{ $value->id }}">
                                  ...
                                  @if($value->kd_kel_des != 00)
                                    ...
                                    <td style="padding-left: 15px;">Kel/Des. {{ $value->nama }}</td>
                                  @else
                                    <td>{{ $value->kd_prov.".".$value->kd_kota_kab.".".$value->kd_kec.".".$value->kd_kel_des }}</td>
                                    <td>Kec. {{ $value->nama }}</td>
                                  @endif
