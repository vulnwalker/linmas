        ...
        <div class="tiles-area">
            ...
            <div class="tiles-grid tiles-group size-2 fg-white">
                <div data-role="tile" data-size="large" data-effect="animate-slide-left" style="cursor: default;">
                    @foreach($slcUploads as $key=>$value)
                        <div class="slide" data-cover="{{ url('assets/images/upload',$value->filename) }}" style="background-image: url({{ url('assets/images/upload',$value->filename) }}); background-size: cover; background-repeat: no-repeat; z-index: 1; left: 0px;"></div>
                    @endforeach
            ...
            <div class="grid">
                <div class="row" style="width: 1285px;">
                    <div class="cell-12" style="text-align: center;">
                        <img src="{{ asset('assets/images/logo alamat kab serang.png') }}"> | <a href="{{ url('usersLogin/usersLogin') }}" target="_blank" style="cursor: pointer; color: white;">
	            ...
	            <div class="row" style="width: 1285px;">
                    ...
                    {{-- <div class="cell-3" style="padding-right: 0px; padding-left: 0px;">
                        <img src="{{ asset('assets/images/logo alamat kab serang.png') }}">
                    </div> --}}
	            </div>
	        </div>
                        ...
                        <div class="col-md-12">
                          <table  class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                          	...
                          	<tbody id="tbody">
                          		@foreach($slcUserLogin as $key=>$value)
                      			   <tr id="{{ $value->id }}">
                                      ...
                                      <td>{{ $value->nama }}</td>
                                      <td>{{ $value->nm_kec }}</td>
                                      <td>{{ $value->nm_kel_des }}</td>
                                      <td>{{ date("d-m-Y H:i:s", strtotime($value->login)) }}</td>
                                      <td>{{ date("d-m-Y H:i:s", strtotime($value->logout)) }}</td>
                                    </tr>
                          		@endforeach
                          	</tbody>
                          </table>
                    ...
                    <div class="instruction">
                      <div class="row">
                        <div class="col-md-12">
                          ...
                          <input type="hidden" name="kd_kec" id="kd_kec" value="{{ Auth::user()->kd_kec }}">
                          <input type="hidden" name="kel_des" id="kel_des" value="{{ Auth::user()->kel_des }}">
                          <input type="hidden" name="nm_kec" id="nm_kec" value="{{ Auth::user()->nm_kec }}">
                          <input type="hidden" name="nm_kel_des" id="nm_kel_des" value="{{ Auth::user()->nm_kel_des }}">
                        </div>
                      </div>
                    </div>
                    <div class="instruction">
