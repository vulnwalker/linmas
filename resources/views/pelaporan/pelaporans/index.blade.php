 ...
 <div id="loadingData">
            ...
            <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                      @php
                        if (Auth::user()->pelaporan == 1 || Auth::user()->pelaporan == 3) {
                            $idUser     = "pelaporan";
                            $hrefUser   = "";
                            $class      = "pelaporan";
                        }else{
                            $idUser     = "";
                            $hrefUser   = "href=/pelaporan/pelaporans/create";
                            $class      = "";
                        }
                      @endphp
                    <div class="row">
                        ...
                        <div class="col-md-3" style="text-align:right;">
                          ...
                          <input type="hidden" name="hakAkses" id="hakAkses" value="{{ Auth::user()->pelaporan }}">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-2">
                        {{-- <input type="text" name="kec_kel" id="kec_kel" class="form-control"> --}}
                        <select class="form-control" id="kd_kec" name="kd_kec">
                          <option value="0">SELECT</option>
                          @foreach($slcKdKec as $value)
                                ...
                                @foreach($Pelaporan as $item)
                                  ...
                                  ?>
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            <a href="{{ url('/pelaporan/PDF/' . $item->id) }}" target="_blank" title="View ContentPublikasi"><button class="btn btn-info btn-sm">Download</button></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
    ...
    function editData() {
      ...
      if(hakAkses == 1 || hakAkses == 3){
        ...
        location.href="/pelaporan/pelaporans/"+id+"/edit";
