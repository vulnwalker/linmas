                      ...
                      <div class="nav-tabs-navigation">
                        <div class="nav-tabs-wrapper">
                          <ul id="tabs" class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                              <a class="nav-link" href="{{ url("publikasi/publikasi") }}" aria-expanded="false" style="color: blue; font-weight: bold; padding-right: .2rem;">Kategori Publikasi |</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div >
                          <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                              ...
                              <tbody id="tbody">
                                @foreach($slcPublikasi as $key=>$value)
                                <tr id="{{ $value->id }}">
