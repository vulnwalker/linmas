                      ...
                      <div class="nav-tabs-navigation">
                        <div class="nav-tabs-wrapper">
                          <ul id="tabs" class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                              <a class="nav-link" href="{{ url("regu/regu") }}" aria-expanded="false" style="color: blue; font-weight: bold; padding-right: .2rem;">Regu Anggota |</a>
                            </li>
                            <li class="nav-item">
