                  ...
                  <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-3" style="text-align:right;">
                          ...
                          <a href="{{ url('/penugasan/penugasan/create') }}" class="btn btn-success btn-sm" title="Add New Kecamatan" >
                              Baru
                          </a>
                       ...
                       <div class="row" style="margin-bottom: 1%;">
                        ...
                        <div >
                          <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <div class="pagination-wrapper"> {!! $penugasans->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
