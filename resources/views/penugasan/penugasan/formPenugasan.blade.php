...
<div class="row">
  {!! Form::label('jenis_penugasan', 'Jenis Penugasan', ['class' => 'col-md-2 col-form-label']) !!}
  <div class="col-md-5">
    <div class="form-group">
      {!! Form::select('jenis_penugasan', ['' => '', '1' => 'Pilpres 2019', '2' => 'Perlombaan 17 Agustus'], '', ['class' => 'form-control']) !!}
    </div>
  </div>
  {!! $errors->first('jenis_penugasan', '<p class="help-block">:message</p>') !!}
 </div>

 <div class="form-group{{ $errors->has('tgl_penugasan_mulai') ? 'has-error' : ''}}">
   <div class="row">
     {!! Form::label('tgl_penugasan_mulai', 'Tanggal Penugasan', ['class' => 'col-md-2 col-form-label']) !!}
     <div class="col-md-2">
       <div class="form-group">
