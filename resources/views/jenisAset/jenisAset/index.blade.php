...
@section('content')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                      <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <a href="{{ url('jenisAset/jenisAset/create') }}">
                      ...
                      <div class="row">
                        <div class="col-md-1">
                          <label class="control-label">JENIS ASSETS</label>
                        </div>
                        <div class="col-md-2">
                          <input type="text" name="jns_assets" id="jns_assets" class="form-control">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-1">
    ...
    $(document).ready(function(){
      ...
      $('#search').on('click', function(){
          $.ajax({
          url: '/tugas/srcJnsAset/',
            data: {
              jns_assets: $("#jns_assets").val()
            },
            type: "GET",
            dataType: "json",
