                  ...
                  <div class="card-header" style="margin-top: -1%;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4" style="text-align:right;">
                          ...
                          <a  class="btn btn-success btn-sm {{ $class }}" {{ $onclik }} style="color:white;">
                             ...
                             <table  class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                @foreach($pembinaan as $item)
                                    <tr >
                                        ...
                                        <td>{{ $item->lokasi }}</td>
                                        <td>{{ $item->kegiatan }}</td>
                                        <td>{{ date("d-m-Y", strtotime($item->tanggal_mulai)) }} s/d {{ date("d-m-Y", strtotime($item->tanggal_selesai)) }}</td>
