            ...
            <div class="col-md-12">
                <div class="card">
                 <div class="card-header">
                  <div class="row">
                      <div class="col-md-12">
                        <h4 class="card-title">Edit Pembinaan #{{ $pembinaan->nama }}</h4>
                        <hr>
                      </div>
                  </div>
                  </div>
                    <div class="card-body">
                        ...
                        @include ('pembinaan.pembinaan.form', ['formMode' => 'edit'])

                     <hr style="margin-bottom: 1px;">
                      
                      <div class="row">
                        {!! Form::label('penyelengara', 'Peserta Linmas :', ['class' => 'col-md-3 col-form-label','style' => 'margin-bottom: -1px;']) !!}
                        ...
                        <div>
                              <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody id="tmpBody">
                                @foreach($tempPembinaan as $item)
                                    <tr>
                                        <td style="text-align: center;line-height: 40px;">{{ $loop->iteration or $item->id }}</td>
                                        <td style="text-align: center;">
                                          <div class="form-check" style="padding-left: 0rem;">
                                            <label class="form-check-label" style="padding-left: 30px;">
                                              <input type="checkbox" class="checkbox" value="{{ $item->Ids }}">
                                              <span class="form-check-sign"></span>
                                            </label>
                                          </div>
                                      </td>
                        ...
                        <!--       <a href="{{ url('/posJaga/pos-jaga') }}" title="Back" class= "btn btn-primary" style= "width: 100%;font-size: 17px;"> -->
                        ...
                        <!--         Simpan -->
                            ...
                            <div class="col-md-2">
                              <a href="{{ url('/pembinaan/pembinaan') }}" title="Back" class= "btn btn-danger" style= "width: 100%;font-size: 17px;">
                                Batal
                              </a>
                            </div>
                          </div>
                                      ...
                                      <div class="row">
                                         ...
                                         <div class="col-md-12">
                                           <div class="row">
                                            <div class="col-md-1">
                                             ...
                                             <div class="col-md-5">
                                               {!! Form::select('jabatan', $Jabatan, null, ('required' == 'required') ? ['id' => 'jabatan','class' => 'form-control', 'required' => 'required','style' => 'width:100%;margin-bottom: 2%;'] : ['class' => 'form-control']) !!}
                                             </div>
                                           </div>
                                        ...
                                        <div class="col-md-12">
                                          <div class="row">
                                            ...
                                            <div class="col-md-3">
                                              {!! Form::text('namaLinmas', null, ('required' == 'required') ? ['id' => 'namaLinmas','class' => 'form-control', 'required' => 'required','style' => 'margin-bottom: 2%;'] : ['class' => 'form-control']) !!}
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                              {!! Form::text('noAnggota', null, ('required' == 'required') ? ['id' => 'noAnggota','class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
                                            </div>
                                          </div>
                                        </div>
                              ...
                              <table class="table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                @foreach($linmas as $item)
                                    <tr style="font-size: 12px;">
                                        ...
                                        <td style="text-align: center;">{{ $item->no_angota }}</td>
                                        <td style="padding-left: 10px;">- {{ $item->nama }} <br>
                                            - {{ $item->jenis_kelamin }} <br>
                                            - {{ $item->tempat_lahir }}, {{ $item->tgl_lahir }}</td>
                                        <td style="padding-left: 10px;">   {{ $item->alamat }}
                                          <br> Rt {{ $item->rt }} - Rw {{ $item->rw }}
                                          <br> {{ $item->alamat_kecamatan }}
                                          <br> {{ $item->alamat_kelurahan}}
                                        </td>
                                        <td style="text-align: center;width: 15%;">
                                          <button type="submit" class="btn btn-success btn-sm" onclick="TambahkanLinmas('{{ Auth::user()->id }}','{{ $item->id }}','{{ $item->no_angota }}')" style="font-size: 11px;">Tambahkan</button>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
