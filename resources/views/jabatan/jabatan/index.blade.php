                      ...
                      <div class="nav-tabs-navigation">
                        <div class="nav-tabs-wrapper">
                          <ul id="tabs" class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                              <a class="nav-link" href="{{ url("jabatan/jabatan") }}" aria-expanded="false" style="color: blue; font-weight: bold; padding-right: .2rem;">Jabatan |</a>
                            </li>
                            <li class="nav-item">
                          ...
                          <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                              <tr>
                                ...
                                {{-- <th style="width: 6%;">JABATAN</th> --}}
                                <th>NAMA JABATAN</th>
                              </tr>
                              </thead>
                              <tbody id="tbody">
                                @foreach($slcJabatan as $key=>$value)
                                <tr id="{{ $value->id }}">
